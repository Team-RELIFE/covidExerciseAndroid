...
//            nicknameText.setText(currentUser.name +"뭔데");
...
//        final String SIGNIN_URL = getString(R.string.db_server)+"login.jsp";  //jsp 파일 연동
...
//
//                                nicknameText.append(""+ name);
//                                EmailText.append(""+ userid);
//
//
//                            }
//                        }
